...
lora_config = LoraConfig(
    ...
    use_rslora = True,
    lora_dropout = 0.1,
    trainable_token_indices = [128260, 128259, 128258, 128257],    #If we add special tokens (like we are doing below), then we want them to be trainable (except the pad token which we leave as non-trainable)
    task_type="CAUSAL_LM"
)
...
checkpoint_storage_location = "../../checkpoints/lora"
