...
def train(model, optimizer, scheduler, loss_func, train_loader, val_loader, epochs, initial_val, val_interval, smallest_val_loss, patience, checkpoint_filepath):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if epoch % val_interval == 0:
            ...
            if val_loss < smallest_val_loss:
                ...
                model.save_pretrained(checkpoint_filepath)
            else:
                patience_count += 1
